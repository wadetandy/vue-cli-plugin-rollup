...
let buildProject = (options) => {
  return await create('test-project', options)
}

let addTypecript = (opts) => {
  opts.plugins['@vue/cli-plugin-typescript'] = {}
}

let addBabel = (opts) => {
  opts.plugins['@vue/cli-plugin-babel'] = {}
}
